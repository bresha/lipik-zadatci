...
for i in range(0, image_height - mean_image_height - 1, 10):
    for j in range(0, image_width - mean_image_width - 1, 10):
        ...
        pedestrian_probability = roi_probabilities[0, 1]

        pedestrian_probabitlities.append(pedestrian_probability)
        final_top_left_bb = (j, i)
        final_top_left_bbs.app(final_top_left_bb)
